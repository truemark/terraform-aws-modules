...
variable "subnet_cidr" {
  description = "This is the network cidr of the secondary subnet you want to use"
  type        = string
}
# TODO Spell this out so you know what it is when you read it
...
variable "secondary_intra_subnets" {
  description = "This is the network cidr of the subnet you want to use"
  type = list(object({
    network = string
    cidr    = string
...
variable "secondary_elasticache_subnets" {
  description = "This is the network cidr of the subnet you want to use"
  type = list(object({
    network = string
    cidr    = string
...
variable "secondary_redshift_subnets" {
  description = "This is the network cidr of the subnet you want to use"
  type = list(object({
    network = string
    cidr    = string
...
variable "private_netnum" {
  description = "This variable is needed only if you are using the network_override variable. It is used to set the starting netnum to be used for the private networks"
  type        = number
  default     = null
}
...
variable "secondary_redshift" {
  description = "Ability to add redshift networks. They are not created by default"
  type        = bool
  default     = false
}
variable "secondary_intra" {
  description = "Ability to remove intra networks. Set to false to not create."
  type        = bool
  default     = false
}
...
variable "secondary_elasticache" {
  description = "Ability to remove elasticache networks. Set to false to not create."
  type        = bool
  default     = false
}
variable "secondary_private" {
  description = "Ability to remove private networks. Set to false to not create."
  type        = bool
  default     = false
}
variable "secondary_public" {
  description = "Ability to remove public networks. Set to false to not create."
  type        = bool
  default     = false
}
