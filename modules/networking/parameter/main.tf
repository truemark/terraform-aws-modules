locals {
  should_create_public_ssm_parameter = var.create && var.public
  should_create_private_ssm_parameter = var.create && var.private
  should_create_intra_ssm_parameter = var.create && var.intra
  should_create_redshift_ssm_parameter = var.create && var.redshift
  should_create_database_ssm_parameter = var.create && var.database
  should_create_elasticache_ssm_parameter = var.create && var.elasticache
  should_create_outpost_ssm_parameter = var.create && var.outpost
  component_tags = {
