  ...
  tags = merge(var.tags,
    {
      ...
      "automation:component-url"    = "https://registry.terraform.io/modules/truemark/truemark/aws/latest/submodules/database/rds-aurora-postgres",
...
# TODO Review whether this should use the local ../rds-secret module
